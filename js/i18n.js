...
const TRANSLATIONS = {
  en: {
    ...
    'fleet.view_features': 'View Features & Inclusions',
    'fleet.hide_features': 'Hide Features & Inclusions',
    'fleet.sedan.feat1': 'Dual Climate Control Air Conditioning',
    'fleet.sedan.feat2': 'Free High-Speed Mobile Wi-Fi',
    'fleet.sedan.feat3': 'Fuel, Tolls & Driver Lodging Included',
    'fleet.sedan.feat4': 'Chilled Bottled Water Provided Daily',
    'fleet.van.feat1': 'Individual Reclining Luxury Captain Seats',
    'fleet.van.feat2': 'Dual Independent Front & Rear A/C',
    'fleet.van.feat3': 'Fuel, Tolls & Driver Lodging Included',
    'fleet.van.feat4': 'Huge Trunk for Strollers, Surfboards & Bags',
    'fleet.bus.feat1': 'Elevated Panoramic Sightseeing Windows',
    'fleet.bus.feat2': 'High-Capacity Multi-Zone Commercial A/C & PA',
    'fleet.bus.feat3': 'Cavernous Undercarriage Cargo Hold',
    'fleet.bus.feat4': 'Fuel, Expressway Tolls & Crew Lodging Included',
  ...
  fr: {
    ...
    'fleet.btn.whatsapp': 'WhatsApp',
    'fleet.view_features': 'Voir caractéristiques & inclusions',
    'fleet.hide_features': 'Masquer caractéristiques',
    'fleet.sedan.feat1': 'Climatisation automatique bizone',
    'fleet.sedan.feat2': 'Wi-Fi mobile haut débit gratuit',
    'fleet.sedan.feat3': 'Carburant, péages & hébergement du chauffeur inclus',
    'fleet.sedan.feat4': "Bouteilles d'eau fraîche fournies chaque jour",
    'fleet.van.feat1': 'Sièges capitaine inclinables de luxe',
    'fleet.van.feat2': 'Climatisation indépendante avant et arrière',
    'fleet.van.feat3': 'Carburant, péages & hébergement du chauffeur inclus',
    'fleet.van.feat4': 'Grand coffre pour poussettes, planches de surf & bagages',
    'fleet.bus.feat1': 'Grandes fenêtres panoramiques surélevées',
    'fleet.bus.feat2': 'Climatisation commerciale multi-zones & système sono PA',
    'fleet.bus.feat3': 'Soutes à bagages spacieuses sous plancher',
    'fleet.bus.feat4': 'Carburant, péages express & hébergement équipage inclus',
  ...
  ru: {
    ...
    'fleet.btn.whatsapp': 'WhatsApp',
    'fleet.view_features': 'Посмотреть удобства и опции',
    'fleet.hide_features': 'Скрыть детали',
    'fleet.sedan.feat1': 'Двухзонный климат-контроль',
    'fleet.sedan.feat2': 'Бесплатный высокоскоростной Wi-Fi',
    'fleet.sedan.feat3': 'Топливо, платные дороги и проживание водителя включены',
    'fleet.sedan.feat4': 'Охлажденная бутилированная вода ежедневно',
    'fleet.van.feat1': 'Индивидуальные капитанские кресла с регулировкой',
    'fleet.van.feat2': 'Раздельный кондиционер спереди и сзади',
    'fleet.van.feat3': 'Топливо, платные дороги и проживание водителя включены',
    'fleet.van.feat4': 'Вместительный багажник для колясок, досок для серфинга и сумок',
    'fleet.bus.feat1': 'Высокие панорамные окна для осмотра достопримечательностей',
    'fleet.bus.feat2': 'Мощный многозонный кондиционер и микрофон гида (PA)',
    'fleet.bus.feat3': 'Вместительные багажные отделения под полом',
    'fleet.bus.feat4': 'Топливо, скоростные трассы и проживание экипажа включены',
  ...
  zh: {
    ...
    'fleet.view_features': '查看配置与全包服务',
    'fleet.hide_features': '收起配置详情',
    'fleet.sedan.feat1': '双温区自动空调系统',
    'fleet.sedan.feat2': '免费高速车载 Wi-Fi 网络',
    'fleet.sedan.feat3': '包含全程油费、过路费及司机食宿',
    'fleet.sedan.feat4': '每日免费提供冰镇瓶装饮用水',
    'fleet.van.feat1': '独立可调节奢华航空队长座椅',
    'fleet.van.feat2': '前后独立双温区空调出风口',
    'fleet.van.feat3': '包含全程油费、过路费及司机食宿',
    'fleet.van.feat4': '超大后备箱空间，可容纳婴儿车、冲浪板与行李',
    'fleet.bus.feat1': '全景高视点观景大车窗',
    'fleet.bus.feat2': '大功率多温区商业空调与专业导游扩音系统',
    'fleet.bus.feat3': '超大底盘贯通式独立行李舱',
    'fleet.bus.feat4': '包含全部燃油、高速路桥费及司乘人员住宿',
  ...
  de: {
    ...
    'fleet.btn.whatsapp': 'WhatsApp',
    'fleet.view_features': 'Ausstattung & Inklusionen anzeigen',
    'fleet.hide_features': 'Ausstattung ausblenden',
    'fleet.sedan.feat1': 'Zwei-Zonen-Klimaautomatik',
    'fleet.sedan.feat2': 'Kostenloses Highspeed-WLAN',
    'fleet.sedan.feat3': 'Kraftstoff, Maut & Fahrerunterkunft inklusive',
    'fleet.sedan.feat4': 'Täglich gekühltes Mineralwasser inklusive',
    'fleet.van.feat1': 'Individuell verstellbare Luxus-Einzelsitze',
    'fleet.van.feat2': 'Getrennte Klimaanlage für vorn und hinten',
    'fleet.van.feat3': 'Kraftstoff, Maut & Fahrerunterkunft inklusive',
    'fleet.van.feat4': 'Großer Kofferraum für Kinderwagen, Surfbretter & Koffer',
    'fleet.bus.feat1': 'Erhöhte Panorama-Aussichtsfenster',
    'fleet.bus.feat2': 'Leistungsstarke Mehrzonen-Klimaanlage & Reiseleiter-Mikrofon',
    'fleet.bus.feat3': 'Große Unterflur-Gepäckräume',
    'fleet.bus.feat4': 'Kraftstoff, Autobahnmaut & Crew-Unterkunft inklusive',
