...
const DEMO_SEED_INQUIRIES = [
  {
    ...
    vehicle: 'Crossover SUV (Honda Vezel)',
    package: '7-Day Heritage & Hill Country Classic',
    notes: 'Interested in scenic train ride from Kandy to Ella and tea factory tasting. Need baby car seat: No.',
    estimatedTotalUSD: 560,
    convertedTotal: '$560 USD',
  ...
  },
  {
    ...
    vehicle: 'Executive Sedan (Toyota Premio)',
  ...
  },
  {
    ...
    vehicle: 'Luxury Van (Toyota KDH/HiAce)',
